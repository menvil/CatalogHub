...
No ADR was created by Phase 0.1 because the phase records facts and does not make a new architecture decision.
...
| [ADR-0002](0002-transactions-side-effects.md) | Accepted | Transactions and side effects |

...
| Full PHP | `composer test` | Unit, legacy unit, feature, and browser contract tests; Architecture has one canonical owner in `composer test:architecture`, while real screenshot tests stay in the isolated Visual lane |

...
- `BrandFormFixture` provides `brand-form-v3`: one fixed Draft Brand (`Samsung Form Fixture`, ID `13013`) with South Korea, 1938, official/support URLs, contact email, `#1428A0`, fixed timestamps, and a deterministic local assigned logo for CA-013 edit/browser/visual coverage. The browser harness loads it separately after `BrandListFixture`; it is never production demo data.

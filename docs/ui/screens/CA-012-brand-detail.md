...
responsive: Wide desktop uses independent 68/32 main and operational stacks and a three-column Identity overview; 1024 and 768 use a bounded single-column dashboard with a two-column internal overview; mobile uses a one-column overview and deliberately orders Identity with its integrated Summary/Classification, Issues, Recent Products and External identities, keeps dialogs inside 390×844, and prevents page-level overflow.

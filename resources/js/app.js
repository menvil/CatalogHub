...
import { bootTagInputs } from './admin/tag-input';
import { bootActionProgress } from './admin/action-progress';
import { bootBrandList } from './admin/brand-list';
import { bootBrandTranslations } from './admin/brand-translations';
import { bootAdminUserMenus } from './admin/user-menu';
import { bootAdminRowActions } from './admin/row-actions';

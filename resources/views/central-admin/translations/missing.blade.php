@extends('layouts.central-admin', ['activeNav' => 'Translations', 'pageTitle' => 'Missing Translations'])

@section('content')
    <x-admin.card>
        <h2 class="mb-4 text-lg font-semibold">Missing Translations</h2>
        <div class="overflow-x-auto">
            <table class="min-w-full text-left text-sm">
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td class="py-4 text-admin-muted" colspan="4">No missing translations.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>

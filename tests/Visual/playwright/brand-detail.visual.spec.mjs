...
const states = [
    ...
    { state: 'active', name: 'ca-012__active__1024x900.png', width: 1024, height: 900, url: '/admin/central/brands/20', maxDiffPixelRatio: 0.03 },
    { state: 'active', name: 'ca-012__active__768x1024.png', width: 768, height: 1024, url: '/admin/central/brands/20', maxDiffPixelRatio: 0.03 },
